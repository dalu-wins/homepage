...
<div class="container mx-auto px-4">
    <div
        class="flex flex-col md:flex-row justify-center gap-12 pt-10 mb-12 w-full items-center"
        id="profile"
    >
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {#each projects as project}
            <Card
                class="relative p-6 mb-6 flex flex-col items-center text-center md:items-start md:text-left"
            >
                {#if project.badge}
